load('/Users/francois/Documents/DATA/SeaFlow/Cell_Division/data/Thompson_9/prochloro_dist_Ncat64_Thompson_9')
Par <- read.csv('/Users/francois/Documents/DATA/SeaFlow/Thompson/Thompson_9/Par_Thompson_9')
Par$time <- strptime(paste(Par$date, Par$time), "%d-%m-%Y %H:%M:%S", tz="GMT")
